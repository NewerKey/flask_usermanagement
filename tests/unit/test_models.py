...
def test_new_user():
    ...
    assert user.email == 'john45@gmail.com'
    assert user.password_hashed != 'Somepassword'
    assert user.__repr__() == '<User: john45@gmail.com>'
...
def test_new_user_with_fixture(new_user):
    ...
    """
    assert new_user.email == 'john45@gmail.com'
    assert new_user.password_hashed != 'Somepassword'
...
def test_setting_password(new_user):
    ...
    assert not new_user.is_password_correct('Somepassword')
